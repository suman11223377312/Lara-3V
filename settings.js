...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "vJJRFQIT#Q8nK1FONYYWFdSAm2lxkiYCU1BC19p-7IUzrz1rgkrg", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "7679396342",
DEV: process.env.DEV || "7679396342",
